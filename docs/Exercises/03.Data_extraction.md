...
## a) Write an Awk script to collect the "MD temperature" in one column vs. the "MD step" i.e.
```
0  300.0000
10 321.5166
20 329.9581
```
which is much nicer format to plot, analyze or read by other programs.
