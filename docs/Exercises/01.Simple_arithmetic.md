...
Modify the script to count only the files in your home directory (hopefully you have some in your home folder) (_hint: directories begin with ”d” in the access field_) ( * )
